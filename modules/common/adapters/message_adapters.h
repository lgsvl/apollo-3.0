...
using ImageFrontCompressedAdapter = Adapter<::sensor_msgs::CompressedImage>;
using ImageShortCompressedAdapter = Adapter<::sensor_msgs::CompressedImage>;
using ImageLongCompressedAdapter = Adapter<::sensor_msgs::CompressedImage>;
